...
Critical notifications are generated by validating the file against the XML Schema for the Activity or Organisation standard, as appropriate. Any schema validation error will result in a Critical error being raised. 

Typically, Critical notifications relate to file format, field naming and data structure. 
