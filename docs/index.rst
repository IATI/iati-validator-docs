...
A number of donors have their own requirements for their grantees; the IATI Validator does not check for these. For assistance, contact the relevant donor. IATI does publish `donor reporting requirement guidance <https://iatistandard.org/en/guidance/standard-overview/donors-reporting-requirements/>`_ , which represents IATI's most current information. 
